...
def run_hill_climbing(distance_matrix, iterations):
    """
    ...
    for i in range(iterations):
        ...
        hypothesis = get_random_hypothesis(hypothesis)
...
def get_random_hypothesis(hypothesis):
    """
...
if __name__ == '__main__':
    ...
    optimal_hypothesis = run_hill_climbing(distance_matrix, ITERATIONS)
